@echo off
echo ========================================
echo    ConfirmaBot - Script de Construccion
echo ========================================
echo.
...
echo [2/4] Generando archivo .spec...
...
if exist "dist\ConfirmaBotHostinger.exe" (
    echo ✅ Ejecutable creado exitosamente!
    echo 📁 Ubicacion: dist\ConfirmaBotHostinger.exe
) else (
...
echo ========================================
echo.
echo 📁 Ejecutable: dist\ConfirmaBotHostinger.exe
